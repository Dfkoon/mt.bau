...
export const announcements = [
    ...
    },
    {
        ...
        content: {
            ar: (
                <p>
                    جامعة البلقاء التطبيقية تفر باتيار 17 من أعضاء هيئتها التدريسي ضمن قائم أفضل 2% من الباحثين الأكثر تأثيراً في العالم.
                </p>
            ),
            en: (
                <p>
    ...
    },
    {
        ...
        content: {
            ar: (
                <p>
                    تم الإعلان عن مواعيد السحب والإضاف. يرجى مراجع بوابة الطالب الإلكتروني لمعرف الموعد المصص لك.
                </p>
            ),
            en: (
                <p>

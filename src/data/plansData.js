            ...
            semesters: [
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'oop', name: 'البرمج الموجه للكائنات + متبر', nameEn: 'OOP + Lab', credits: 4, prereq: 'comp_skills' },
                        { id: 'logic', name: 'تصميم المنطق الرقمي + متبر', nameEn: 'Digital Logic + Lab', credits: 4 },
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'networks1', name: 'شبكات الحاسوب (1) + متبر', nameEn: 'Networking 1 + Lab', credits: 4, prereq: 'logic' },
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'db_design', name: 'تصميم وإدار قواعد البيانات + متبر', nameEn: 'DB Design + Lab', credits: 4 },
                        { id: 'net_sec', name: 'أمن شبكات + متبر', nameEn: 'Network Security + Lab', credits: 4, prereq: 'networks1' },
            ...
            semesters: [
                ...
                },
                {
                    ...
                    courses: [
                        { id: 'discrete', name: 'هياكل ورياضيات منفصل', nameEn: 'Discrete Mathematics', credits: 3, prereq: 'math102' },
                        { id: 'stats', name: 'الاحتمالات والإحصاء', nameEn: 'Probability & Statistics', credits: 3, prereq: 'math102' },
                        { id: 'networks1', name: 'شبكات الحاسوب (1) + متبر', nameEn: 'Networking 1 + Lab', credits: 4 },
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'mobile_dev', name: 'تطوير تطبيقات الهاتف المحمول + متبر', nameEn: 'Mobile App Dev + Lab', credits: 4, prereq: 'scripting' },
                ...
                },
                {
                    ...
                    name: 'الفصل السادس',
                    courses: [
                        { id: 'adv_crypto', name: 'التشفير المتقدم + متبر', nameEn: 'Advanced Cryptography + Lab', credits: 4, prereq: 'crypto_basics' },
                        { id: 'os_eng', name: 'هندس نظم التشغيل + متبر', nameEn: 'OS Engineering + Lab', credits: 4 },
                        { id: 'db_design', name: 'تصميم وإدار قواعد البيانات + متبر', nameEn: 'DB Design + Lab', credits: 4 },
                        { id: 'ml', name: 'تعلم الآل + متبر', nameEn: 'Machine Learning + Lab', credits: 4, prereq: 'ai_intro' },
            ...
            semesters: [
                ...
                },
                {
                    ...
                    courses: [
                        { id: 'discrete', name: 'هياكل ورياضيات منفصل', nameEn: 'Discrete Mathematics', credits: 3, prereq: 'math102' },
                        { id: 'stats', name: 'الاحتمالات والإحصاء', nameEn: 'Probability & Statistics', credits: 3, prereq: 'math102' },
                        { id: 'ds', name: 'هياكل البيانات + متبر', nameEn: 'Data Structures + Lab', credits: 4, prereq: 'oop' },
                        { id: 'ds_fundamentals', name: 'أساسيات علم البيانات + متبر', nameEn: 'DS Fundamentals + Lab', credits: 4 },
                        { id: 'ai_intro', name: 'مقدم في الذكاء الاصطناعي', nameEn: 'AI Intro', credits: 3 }
                    ]
                },
                {
                    ...
                    name: 'الفصل الرابع',
                    courses: [
                        { id: 'adv_ds', name: 'هياكل بيانات متقدم + متبر', nameEn: 'Advanced Data Structures + Lab', credits: 4, prereq: 'ds' },
                        { id: 'algorithms', name: 'تصميم وتحليل الوارزميات + متبر', nameEn: 'Algorithms + Lab', credits: 4, prereq: 'ds' },
                        { id: 'data_mining', name: 'تنقيب البيانات + متبر', nameEn: 'Data Mining + Lab', credits: 4, prereq: 'stats' },
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'db_design', name: 'تصميم وإدار قواعد البيانات (1) + متبر', nameEn: 'DB Design 1 + Lab', credits: 4 },
            ...
            semesters: [
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'stats', name: 'الاحتمالات والإحصاء', nameEn: 'Probability & Statistics', credits: 3, prereq: 'math102' },
                        { id: 'comp_skills2', name: 'مهارات الحاسوب (2) لطلب الكليات العلمي + متبر', nameEn: 'Computer Skills 2 (Scientific) + Lab', credits: 3, prereq: 'comp_skills' },
                        { id: 'eng102', name: 'لغ إنجليزي تطبيقي (2)', nameEn: 'Applied English 2', credits: 3, prereq: 'eng101' }
                    ]
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'oop', name: 'البرمج الموجه للكائنات + متبر', nameEn: 'OOP + Lab', credits: 4, prereq: 'comp_skills2' },
                        { id: 'logic', name: 'تصميم المنطق الرقمي + متبر', nameEn: 'Digital Logic + Lab', credits: 4 },
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'robot_circuits', name: 'الدوائر والالكترونيات لطلب الذكاء والروبوتات', nameEn: 'Circuits & Electronics', credits: 3 },
                        { id: 'robot_dynamics', name: 'أساسيات الحركي والديناميكا لطلب الذكاء والروبوتات', nameEn: 'Statics & Dynamics', credits: 3 }
                    ]
                },
                {
                    id: 5,
                    ...
                    courses: [
                        ...
                        { id: 'algorithms', name: 'تصميم وتحليل الوارزميات + متبر', nameEn: 'Algorithms + Lab', credits: 4, prereq: 'ds' },
                        { id: 'robot_control', name: 'أنظم التحكم الآلي للروبوتات + متبر', nameEn: 'Robot Control Systems + Lab', credits: 4 },
                        ...
                        { id: 'deep_learning', name: 'التعلم العميق + متبر', nameEn: 'Deep Learning + Lab', credits: 4, prereq: 'ml' },
                        { id: 'robot_vision', name: 'روبوت الرؤي', nameEn: 'Robot Vision', credits: 3 },
                        { id: 'robot_perception', name: 'روبوتات الإدراك + متبر', nameEn: 'Robot Perception + Lab', credits: 4 },
        ...
        'vr_old': {
            ...
            semesters: [
                ...
                },
                {
                    ...
                    name: 'المستوى الرابع',
                    courses: [
                        { id: 'ds', name: 'هياكل بيانات ووارزميات + متبر', nameEn: 'Data Structures + Lab', credits: 4, prereq: 'oop' },
                        { id: 'image_proc', name: 'معالج الصور', nameEn: 'Image Processing', credits: 3, prereq: 'math_graphics' },
                        { id: 'anim_2d', name: 'رسوم متحرك ثنائي الابعاد + متبر', nameEn: '2D Animation + Lab', credits: 4, prereq: 'comp_draw' },
                ...
                },
                {
                    ...
                    courses: [
                        ...
                        { id: 'game_dev', name: 'تصميم وتطوير الالعاب الالكتروني + متبر', nameEn: 'Game Dev + Lab', credits: 4 },

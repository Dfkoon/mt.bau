...
const fallbackTestimonials = {
    ar: [
        {
            quote: "من أنشأ هذا الموقع مبدع! المظاهر رائعة والعمل متقن. تجربة مستخدم ممتازة 🚀",
            author: "أحمد إسماعيل",
            gender: "male",
        ...
        {
            quote: "ساعدني الموقع كثيراً في دراستي! المواد منظّمة والملخّصات واضحة. شكراً للفريق المتطوّع 💙",
            author: "أحمد محمود",
            gender: "male",
        ...
        {
            quote: "أفضل مصدر للمواد الدراسية! سهّل عليّ التقويم الأكاديمي والاختبارات التفاعلية الدراسة كثيراً 🎓",
            author: "سارة العلي",
            gender: "female",
            major: "علوم الحاسوب",

...
const DEFAULT_GLOW_COLOR = '211, 47, 47'; // Red color
    ...
    return (
        <>
          ...
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --red-primary: rgba(211, 47, 47, 1);
            --red-glow: rgba(211, 47, 47, 0.2);
            --red-border: rgba(211, 47, 47, 0.8);
          }
          
          /* Light theme overrides for bento cards */
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(78, 46, 46, 0.4), 0 0 30px rgba(${glowColor}, 0.2);
          }
                            ...
                            return (
                                ...
                                >
                                    <div className="card__header flex justify-between gap-3 relative text-white">
                                        <span className="card__label text-base font-bold" style={{ color: 'var(--red-primary)' }}>
                                            {card.label}
                                        </span>
                                    </div>

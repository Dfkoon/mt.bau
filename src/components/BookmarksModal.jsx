    ...
    <div className="bookmarks-overlay" onClick={onClose}>
      <div className="bookmarks-container" onClick={(e) => e.stopPropagation()}>
        <div className="bookmarks-header">
          <h3>📌 {isAr ? 'خزانتي الأكاديمية (المحفوظات)' : 'My Saved Locker'}</h3>
        ...
        <div className="bookmarks-list">
          {bookmarks.length === 0 ? (
            <div className="no-bookmarks">
              ...
              <p>{isAr ? 'خزانتك فارغة حالياً' : 'Your saved locker is currently empty'}</p>
              <small>
                {isAr
                  ? 'انقر على خيار الحفظ (📌) بجانب أي مادة أو ملخص للوصول إليه بسرعة هنا'

...
const SHORTCUTS = [
    ...
    { keys: ['?'], keysAr: ['?'], labelAr: 'عرض اختصارات لوحة المفاتيح', labelEn: 'Show keyboard shortcuts' },
    { keys: ['Esc'], keysAr: ['Esc'], labelAr: 'إغلاق أي نافذة مفتوحة', labelEn: 'Close any open modal' },
    { keys: ['Alt', '←'], keysAr: ['Alt', '→'], labelAr: 'العودة للصفحة السابقة', labelEn: 'Go back to previous page' },
    { keys: ['Alt', '→'], keysAr: ['Alt', '←'], labelAr: 'الذهاب للصفحة التالية', labelEn: 'Go forward to next page' },
];
        ...
        <div className="kb-shortcuts-overlay" onClick={() => setOpen(false)} role="dialog" aria-modal="true">
            <div className="kb-shortcuts-modal glass-card" onClick={e => e.stopPropagation()}>
                <div className="kb-header">
                    <h2 className="kb-title">⌨️ {isAr ? 'اختصارات لوحة المفاتيح' : 'Keyboard Shortcuts'}</h2>
